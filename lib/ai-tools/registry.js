...
const AI_TOOLS = {
  ...
  'omniroute': {
    ...
    command: 'omniroute',
    args: [],
    displayName: 'OmniRoute Claude Code',
    description: 'Claude Code launched through OmniRoute auto-best-coding',
    website: 'https://github.com/diegosouzapw/OmniRoute',
    checkInstalled: async () => await commandExists('omniroute')
  },
};
